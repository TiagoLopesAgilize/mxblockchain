...
curl -H "Content-type:application/json" --data '{"data" : "Tiago Lopes, 82316201504, 15/06/2018, 14:99"}' http://45.55.144.89:3001/mineBlock


curl -H "Content-type:application/json" --data '{"data" : "Tiago Lopes, 82316201504, 15/06/2018, 14:99"}' http://167.99.239.159/ws/mineBlock

curl -H "Content-type:application/json" --data '{"data" : "Tiago Lopes, 82316201504, 15/06/2018, 14:99"}' http://167.99.239.159:3001/mineBlock
